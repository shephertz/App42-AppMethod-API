...
function TCustomApp42ConnectionInfo.GetUserName: string;
begin
  Result := FConnectionInfo.UserName;
end;

procedure TCustomApp42ConnectionInfo.SetUserName(const Value: string);
begin
...
const
  sDisplayName = 'App42';
initialization
  TBackendProviders.Instance.Register(TCustomApp42Provider.ProviderID, sDisplayName);
finalization
