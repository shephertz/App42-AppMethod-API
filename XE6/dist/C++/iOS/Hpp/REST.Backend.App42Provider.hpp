...
// (DO NOT EDIT: machine generated header) 'REST.Backend.App42Provider.pas' rev: 27.00 (iOS)
...
{
  _INIT_UNIT(Rest_Backend_App42provider);
}	/* namespace App42provider */
}	/* namespace Backend */
}	/* namespace Rest */
...
public:
	#define TCustomApp42Provider_ProviderID u"App42"
