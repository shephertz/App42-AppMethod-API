...
// (DO NOT EDIT: machine generated header) 'REST.Backend.App42Api.pas' rev: 27.00 (iOS)
...
public:
	...
	/* Exception.CreateRes */ inline __fastcall EApp42APIError(System::PResStringRec ResStringRec) : Rest::Backend::Exception::EBackendError(ResStringRec) { }
	/* Exception.CreateResFmt */ inline __fastcall EApp42APIError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High) : Rest::Backend::Exception::EBackendError(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateResHelp */ inline __fastcall EApp42APIError(System::PResStringRec ResStringRec, int AHelpContext) : Rest::Backend::Exception::EBackendError(ResStringRec, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EApp42APIError(System::PResStringRec ResStringRec, System::TVarRec const *Args, const int Args_High, int AHelpContext) : Rest::Backend::Exception::EBackendError(ResStringRec, Args, Args_High, AHelpContext) { }
...
_DECLARE_METACLASS(System::TMetaClass, TApp42APIErrorClass);
...
public:
	...
	{
public:
		#define TApp42Api_TDeviceNames_IOS u"ios"
		
		#define TApp42Api_TDeviceNames_Android u"android"
...
private:
	#define TApp42Api_sStorage u"storage"
	
	#define TApp42Api_sFiles u"upload"
	
	#define TApp42Api_sUsers u"user"
	
	#define TApp42Api_sPush u"push"
	
	#define TApp42Api_sSession u"session"
	
	
public:
	#define TApp42Api_cDefaultApiVersion u"1.0"
	
	#define TApp42Api_cDefaultBaseURL u"https://api.shephertz.com/cloud/1.0/"
